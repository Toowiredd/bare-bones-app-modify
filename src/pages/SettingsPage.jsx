    ...
    <div className="min-h-screen p-4 bg-gray-100">
      ...
      <div className="mb-4">
        ...
        <div className="flex space-x-2 mb-2">
          ...
          />
          <button onClick={handleAddKeyword} className="px-4 py-2 bg-blue-500 text-white rounded">
            Add
          </button>
        </div>
        <ul className="list-disc pl-5">
          {keywords.map((keyword, index) => (
            <li key={index} className="flex justify-between items-center">
              {keyword}
              <button onClick={() => handleRemoveKeyword(index)} className="px-2 py-1 bg-red-500 text-white rounded">
                Remove
              </button>
            </li>
          ))}
